...
System.register("index", [], function() {
  "use strict";
  var __moduleName = "index";
  var Consultant = function Consultant(name) {
    this.name = name;
  };
  ($traceurRuntime.createClass)(Consultant, {present: function(topic) {
      console.log(this.name + ' talks a lot bla bla in the presentation about ' + topic);
    }}, {});
  var SeniorConsultant = function SeniorConsultant(name, level) {
    $traceurRuntime.superCall(this, $SeniorConsultant.prototype, "constructor", [name]);
    this.level = level;
  };
  var $SeniorConsultant = SeniorConsultant;
  ($traceurRuntime.createClass)(SeniorConsultant, {present: function() {
      $traceurRuntime.superCall(this, $SeniorConsultant.prototype, "present", ['Global Management and Marketing Management Solution']);
    }}, {}, Consultant);
